...
export default function SearchBar({products, setSearchedProducts}) {
  ...
  <div className="bg-white w-full px-2">
    <div className="flex mt-3 mb-2 border-2 py-1 flex justify-between rounde-md rounded-md">
      <input onChange={(e) => {
      ...
      <div className="mr-2">
        <spa>
          ...
          }} xmlns="http://www.w3.org/2000/svg" className="overflow-visible h-6 w-6 text-gray-400 hover:text-blue-400 transition duration-100 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
